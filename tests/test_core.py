...
def test():
    ...
    with h5py.File(data_dir / 'test_data.hdf') as h5:
        ...
        data = PySINDyData(h5['free/time'][0:100], {'x': h5['free/signal'][0:100]}, True, 0.001, 1000)
        ...
        # driven:
        data = PySINDyData(h5['driven/time'][0:100], {'x': h5['driven/signal'][0:100]}, True, 0.0001, 4000)
